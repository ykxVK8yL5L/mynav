...
Or mount your own code to be served by PHP-FPM & Nginx
    ...
    docker run -p 80:8080 -v ~/my-codebase:/var/www/html ykxvk8yl5l/mynav:latest
...
Nginx configuration:
    ...
    docker run -v "`pwd`/nginx-server.conf:/etc/nginx/conf.d/server.conf" ykxvk8yl5l/mynav:latest

PHP configuration:

    docker run -v "`pwd`/php-setting.ini:/etc/php7/conf.d/settings.ini" ykxvk8yl5l/mynav:latest

PHP-FPM configuration:

    docker run -v "`pwd`/php-fpm-settings.conf:/etc/php7/php-fpm.d/server.conf" ykxvk8yl5l/mynav:latest
